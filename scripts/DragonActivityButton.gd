...
func _on_button_up():
	if GameManaging.money >= 3000 and _is_valid_location == true:
		GameManaging.money -= 3000
		...
		no_money.text = "Not enough money, need " + str(3000 - GameManaging.money)+ " more to buy"
