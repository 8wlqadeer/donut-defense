...
var enemy_speed:float = 0.25
var enemy_health:int = 5000
var enemy_worth:int = 200
...
func _ready():
	...
	$Path3D/PathFollow3D/donutEnemyboss.show()
...
func _on_spawning_state_entered():
	...
	$AnimationPlayer.play("BossSpawn")
...
func _on_despawning_state_entered():
	$AnimationPlayer.play("BossDespawn")
	await $AnimationPlayer.animation_finished
...
func _death():
		$Path3D/PathFollow3D/donutEnemyboss.hide()
		$Path3D/PathFollow3D/donutEnemyBasicToxic.hide()
